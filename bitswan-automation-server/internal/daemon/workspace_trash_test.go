...
// background goroutine that calls traefikapi.DeleteTraefikRecordsWithWriter()
// (more `docker` calls, plus Linux-oriented ingress teardown) while still
// writing to the test's buffer.
//
