...
// bitswanFavicon is the <link> tag every full-page Bailey HTML head
// includes so the browser tab shows the BitSwan mark. Points at the
// static favicon the bailey static handler serves.
