...
export default tseslint.config(
  // Files we never want to lint.
  {
    ignores: [
      ...
      'client/dist/**',
      'server/dist/**',
      // Generated by browser-tests/build-harness.mjs.
  ...
  // Browser tests: Node scripts that also carry `page.evaluate` callbacks,
  // whose bodies execute in the browser — so both global sets apply.
  {
    files: ['browser-tests/**/*.{mjs,tsx}'],
    languageOptions: {
      sourceType: 'module',
