...
// The backend is a private worker, reached same-origin through the frontend
// shim at /api (the shim strips /api and forwards to the backend worker).
// Internal endpoints live under /internal on the backend → /api/internal here.
export const getBackendUrl = (): string | null => '/api/internal'
