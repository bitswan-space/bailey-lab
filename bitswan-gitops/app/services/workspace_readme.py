...
GENERATED_MARKER = (
    "<!-- generated by Bailey; delete this line to take over this file -->"
)
LEGACY_MARKER = "is the git mirror of the [Bailey](https://bitswan.ai) workspace"


def is_generated_readme(text: str) -> bool:
    return GENERATED_MARKER in text or LEGACY_MARKER in text
...
Bailey regenerates this file whenever its wording changes. To write your own,
delete the first line of the file; Bailey then leaves it alone.
"""
