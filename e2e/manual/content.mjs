  ...
  chapters: [
    ...
    },
    {
      ...
      sell: [
        ...
        'Your own actions are shown as <strong>yours</strong>, beside that status and never instead of it. Press <b>Restart</b> and a spinner appears next to the service — on this list, on the stage card and on the pipeline — and it stays until Bailey has actually <strong>seen the container come back</strong>, not merely until the request was accepted. So “I am restarting this on purpose” and “this keeps dying by itself” can never be mistaken for one another, and a service that briefly reads as down during your own restart says who put it there.',
