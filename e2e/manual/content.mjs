  ...
  chapters: [
    ...
    },
    {
      ...
      steps: [
        ...
        'Press <b>Enable single sign-on</b>. Sign-in now offers both your provider and Bitswan accounts.',
      ],
      callout: { kind: 'Keep a way back in', text: 'Adding a provider never removes Bitswan sign-in, and that is on purpose. If your identity provider goes down, its certificate lapses, or its client secret is rotated out from under you, an administrator can still sign in with a Bitswan account and correct the configuration. Never treat single sign-on as your only door.' },
      standards: [
