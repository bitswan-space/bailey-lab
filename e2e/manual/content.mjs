  ...
  chapters: [
    ...
    // ───────────────────────── Inside the workspace ─────────────────────────
    {
      ...
      slots: [
        ...
        { id: 'workspace-settings', afterPara: 1, label: 'Live capture', caption: 'Advanced → Settings (admins only) · the workspace’s own SSH deploy key, ready to copy, and the git remote the workspace is mirrored to — one repository, one folder per process on main, and the deployment manifests on gitops' },
