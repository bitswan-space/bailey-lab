  ...
  chapters: [
    ...
    // ───────────────────────── Inside the workspace ─────────────────────────
    {
      ...
      slots: [
        ...
        { id: 'experiment', label: 'Live capture', caption: 'Inside an experiment · the green banner names the business process it is on and the experiment itself, and carries the only two ways out — merge it back into your copy, or discard it. There is no Deploy tab in here.' },
