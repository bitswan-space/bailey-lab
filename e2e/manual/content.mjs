  ...
  chapters: [
    ...
    // ───────────────────────── Inside the workspace ─────────────────────────
    {
      ...
      slots: [
        ...
        { id: 'experiment', label: 'Live capture', caption: 'Inside an experiment · the green banner names the business process it is on and the experiment itself, and carries all three ways out — step back to your copy leaving it running, merge it back, or discard it. There is no Deploy tab in here.' },
