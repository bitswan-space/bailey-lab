  ...
  chapters: [
    ...
    // ───────────────────────── Inside the workspace ─────────────────────────
    {
      ...
      slots: [
        ...
        { id: 'workspace-settings', afterPara: 1, label: 'Live capture', caption: 'Advanced → Settings (admins only) · the workspace’s own SSH deploy key, ready to copy, and the git remote every business process, manifest and copy is mirrored to — one repository, one folder per process, branches per stage' },
